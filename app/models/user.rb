class User < ActiveRecord::Base
  ...
  attr_accessible :login, :first_name, :last_name, :email, :password, :password_confirmation, :remember_me, :active, :admin, :display_name, :birthday, :business_name, :address1, :address2, :city, :state, :zip_code, :phone_number, :cell_number, :fax_number  
