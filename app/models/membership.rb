class Membership < ActiveRecord::Base  
  ...
  attr_accessible :business_name, :first_name, :last_name, :address_1, :address_2, :city, :state, :postal_code, :date_of_birth, :email, :phone_number, :member_type, :new_member, :license_type, :license_number, :interest_website, :interest_networking, :interest_cpr, :interest_backup, :interest_meetings, :interest_field_trips, :interest_other, :topic_requests, :christmas, :manna, :membership, :public_relations, :publish_address, :referral_info, :token
